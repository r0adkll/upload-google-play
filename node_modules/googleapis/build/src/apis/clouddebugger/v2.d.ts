...
export declare namespace clouddebugger_v2 {
    ...
    export class Resource$Controller$Debuggees {
         ...
         */
        register(params?: Params$Resource$Controller$Debuggees$Register, options?: MethodOptions): GaxiosPromise<Schema$RegisterDebuggeeResponse>;
    ...
    export class Resource$Controller$Debuggees$Breakpoints {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Controller$Debuggees$Breakpoints$List, options?: MethodOptions): GaxiosPromise<Schema$ListActiveBreakpointsResponse>;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Controller$Debuggees$Breakpoints$Update, options?: MethodOptions): GaxiosPromise<Schema$UpdateActiveBreakpointResponse>;
    ...
    export class Resource$Debugger$Debuggees {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Debugger$Debuggees$List, options?: MethodOptions): GaxiosPromise<Schema$ListDebuggeesResponse>;
    ...
    export class Resource$Debugger$Debuggees$Breakpoints {
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Debugger$Debuggees$Breakpoints$Delete, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Debugger$Debuggees$Breakpoints$Get, options?: MethodOptions): GaxiosPromise<Schema$GetBreakpointResponse>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Debugger$Debuggees$Breakpoints$List, options?: MethodOptions): GaxiosPromise<Schema$ListBreakpointsResponse>;
         ...
         * @return {object} Request object
         */
        set(params?: Params$Resource$Debugger$Debuggees$Breakpoints$Set, options?: MethodOptions): GaxiosPromise<Schema$SetBreakpointResponse>;
