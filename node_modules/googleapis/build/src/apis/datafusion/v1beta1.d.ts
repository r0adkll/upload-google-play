...
export declare namespace datafusion_v1beta1 {
    ...
    export class Resource$Projects$Locations$Versions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Versions$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Versions$List, options?: MethodOptions): GaxiosPromise<Schema$ListAvailableVersionsResponse>;
