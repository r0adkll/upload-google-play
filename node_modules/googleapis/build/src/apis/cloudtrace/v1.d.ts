...
export declare namespace cloudtrace_v1 {
    ...
    export class Resource$Projects {
         ...
         */
        patchTraces(params: Params$Resource$Projects$Patchtraces, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Projects$Traces {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Traces$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Traces$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
