...
export declare namespace androidpublisher_v2 {
    ...
    export class Resource$Edits$Apklistings {
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Edits$Apklistings$Update, options?: MethodOptions): GaxiosPromise<Schema$ApkListing>;
        update(params: Params$Resource$Edits$Apklistings$Update, options: MethodOptions | BodyResponseCallback<Schema$ApkListing>, callback: BodyResponseCallback<Schema$ApkListing>): void;
        update(params: Params$Resource$Edits$Apklistings$Update, callback: BodyResponseCallback<Schema$ApkListing>): void;
        update(callback: BodyResponseCallback<Schema$ApkListing>): void;
    }
    export interface Params$Resource$Edits$Apklistings$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Edits$Apklistings$Deleteall extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Edits$Apklistings$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Edits$Apklistings$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Edits$Apklistings$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Edits$Apklistings$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
