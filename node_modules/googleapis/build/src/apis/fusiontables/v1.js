...
(function (fusiontables_v1) {
    ...
    fusiontables_v1.Fusiontables = Fusiontables;
    ...
    fusiontables_v1.Resource$Column = Resource$Column;
    class Resource$Query {
        constructor(context) {
            this.context = context;
        }
        sql(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
        ...
        sqlGet(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
    ...
    fusiontables_v1.Resource$Query = Resource$Query;
    ...
    fusiontables_v1.Resource$Style = Resource$Style;
    class Resource$Table {
        ...
        importRows(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
        ...
        importTable(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    fusiontables_v1.Resource$Table = Resource$Table;
    class Resource$Task {
        constructor(context) {
            this.context = context;
        }
    ...
    fusiontables_v1.Resource$Task = Resource$Task;
    class Resource$Template {
        ...
        delete(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/fusiontables/v1/tables/{tableId}/templates/{templateId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'DELETE',
                }, options),
                params,
    ...
    fusiontables_v1.Resource$Template = Resource$Template;
})(fusiontables_v1 = exports.fusiontables_v1 || (exports.fusiontables_v1 = {}));
