...
export declare namespace displayvideo_v1beta {
    ...
    export class Displayvideo {
        ...
        sdfdownloadtask: Resource$Sdfdownloadtask;
    ...
    export class Resource$Sdfdownloadtask {
        context: APIRequestContext;
        operations: Resource$Sdfdownloadtask$Operations;
        constructor(context: APIRequestContext);
    }
    export class Resource$Sdfdownloadtask$Operations {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Sdfdownloadtask$Operations$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Sdfdownloadtask$Operations$Get, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        get(params: Params$Resource$Sdfdownloadtask$Operations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Sdfdownloadtask$Operations$Get, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        get(params: Params$Resource$Sdfdownloadtask$Operations$Get, callback: BodyResponseCallback<Schema$Operation>): void;
        get(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    export interface Params$Resource$Sdfdownloadtask$Operations$Get extends StandardParameters {
        /**
         * The name of the operation resource.
         */
        name?: string;
