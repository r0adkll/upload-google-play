...
export declare namespace analyticsreporting_v4 {
    ...
    export class Resource$Reports {
         ...
         */
        batchGet(params: Params$Resource$Reports$Batchget, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Useractivity {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        search(params: Params$Resource$Useractivity$Search, options: StreamMethodOptions): GaxiosPromise<Readable>;
