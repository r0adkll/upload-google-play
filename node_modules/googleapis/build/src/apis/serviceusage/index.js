...
exports.VERSIONS = {
    ...
    v1beta1: v1beta1_1.serviceusage_v1beta1.Serviceusage,
};
function serviceusage(versionOrOptions) {
    return googleapis_common_1.getAPI('serviceusage', versionOrOptions, exports.VERSIONS, this);
}
