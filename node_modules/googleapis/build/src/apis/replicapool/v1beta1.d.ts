...
export declare namespace replicapool_v1beta1 {
    ...
    export class Resource$Pools {
         ...
         */
        delete(params?: Params$Resource$Pools$Delete, options?: MethodOptions): GaxiosPromise<void>;
        delete(params: Params$Resource$Pools$Delete, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        delete(params: Params$Resource$Pools$Delete, callback: BodyResponseCallback<void>): void;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Pools$Get, options?: MethodOptions): GaxiosPromise<Schema$Pool>;
        get(params: Params$Resource$Pools$Get, options: MethodOptions | BodyResponseCallback<Schema$Pool>, callback: BodyResponseCallback<Schema$Pool>): void;
        get(params: Params$Resource$Pools$Get, callback: BodyResponseCallback<Schema$Pool>): void;
         ...
         * @return {object} Request object
         */
        insert(params?: Params$Resource$Pools$Insert, options?: MethodOptions): GaxiosPromise<Schema$Pool>;
        insert(params: Params$Resource$Pools$Insert, options: MethodOptions | BodyResponseCallback<Schema$Pool>, callback: BodyResponseCallback<Schema$Pool>): void;
        insert(params: Params$Resource$Pools$Insert, callback: BodyResponseCallback<Schema$Pool>): void;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Pools$List, options?: MethodOptions): GaxiosPromise<Schema$PoolsListResponse>;
        list(params: Params$Resource$Pools$List, options: MethodOptions | BodyResponseCallback<Schema$PoolsListResponse>, callback: BodyResponseCallback<Schema$PoolsListResponse>): void;
        list(params: Params$Resource$Pools$List, callback: BodyResponseCallback<Schema$PoolsListResponse>): void;
         ...
         * @return {object} Request object
         */
        resize(params?: Params$Resource$Pools$Resize, options?: MethodOptions): GaxiosPromise<Schema$Pool>;
        resize(params: Params$Resource$Pools$Resize, options: MethodOptions | BodyResponseCallback<Schema$Pool>, callback: BodyResponseCallback<Schema$Pool>): void;
        resize(params: Params$Resource$Pools$Resize, callback: BodyResponseCallback<Schema$Pool>): void;
         ...
         * @return {object} Request object
         */
        updatetemplate(params?: Params$Resource$Pools$Updatetemplate, options?: MethodOptions): GaxiosPromise<void>;
        updatetemplate(params: Params$Resource$Pools$Updatetemplate, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        updatetemplate(params: Params$Resource$Pools$Updatetemplate, callback: BodyResponseCallback<void>): void;
    ...
    export interface Params$Resource$Pools$Updatetemplate extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export class Resource$Replicas {
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Replicas$Delete, options?: MethodOptions): GaxiosPromise<Schema$Replica>;
        delete(params: Params$Resource$Replicas$Delete, options: MethodOptions | BodyResponseCallback<Schema$Replica>, callback: BodyResponseCallback<Schema$Replica>): void;
        delete(params: Params$Resource$Replicas$Delete, callback: BodyResponseCallback<Schema$Replica>): void;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Replicas$Get, options?: MethodOptions): GaxiosPromise<Schema$Replica>;
        get(params: Params$Resource$Replicas$Get, options: MethodOptions | BodyResponseCallback<Schema$Replica>, callback: BodyResponseCallback<Schema$Replica>): void;
        get(params: Params$Resource$Replicas$Get, callback: BodyResponseCallback<Schema$Replica>): void;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Replicas$List, options?: MethodOptions): GaxiosPromise<Schema$ReplicasListResponse>;
        list(params: Params$Resource$Replicas$List, options: MethodOptions | BodyResponseCallback<Schema$ReplicasListResponse>, callback: BodyResponseCallback<Schema$ReplicasListResponse>): void;
        list(params: Params$Resource$Replicas$List, callback: BodyResponseCallback<Schema$ReplicasListResponse>): void;
         ...
         * @return {object} Request object
         */
        restart(params?: Params$Resource$Replicas$Restart, options?: MethodOptions): GaxiosPromise<Schema$Replica>;
        restart(params: Params$Resource$Replicas$Restart, options: MethodOptions | BodyResponseCallback<Schema$Replica>, callback: BodyResponseCallback<Schema$Replica>): void;
        restart(params: Params$Resource$Replicas$Restart, callback: BodyResponseCallback<Schema$Replica>): void;
