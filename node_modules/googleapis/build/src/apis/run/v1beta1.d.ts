...
export declare namespace run_v1beta1 {
    ...
    export class Resource$Customresourcedefinitions {
         ...
         */
        list(params: Params$Resource$Customresourcedefinitions$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Customresourcedefinitions$List, options?: MethodOptions): GaxiosPromise<Schema$ListCustomResourceDefinitionsResponse>;
    ...
    export class Resource$Namespaces$Customresourcedefinitions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Namespaces$Customresourcedefinitions$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Namespaces$Customresourcedefinitions$Get, options?: MethodOptions): GaxiosPromise<Schema$CustomResourceDefinition>;
    ...
    export class Resource$Projects$Locations$Customresourcedefinitions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Customresourcedefinitions$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Customresourcedefinitions$Get, options?: MethodOptions): GaxiosPromise<Schema$CustomResourceDefinition>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Customresourcedefinitions$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Customresourcedefinitions$List, options?: MethodOptions): GaxiosPromise<Schema$ListCustomResourceDefinitionsResponse>;
