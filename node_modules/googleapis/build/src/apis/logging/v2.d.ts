...
export declare namespace logging_v2 {
    ...
    export class Resource$Billingaccounts$Buckets$Views {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Billingaccounts$Buckets$Views$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Billingaccounts$Buckets$Views$Get, options?: MethodOptions): GaxiosPromise<Schema$LogView>;
        get(params: Params$Resource$Billingaccounts$Buckets$Views$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Billingaccounts$Buckets$Views$Get, options: MethodOptions | BodyResponseCallback<Schema$LogView>, callback: BodyResponseCallback<Schema$LogView>): void;
        get(params: Params$Resource$Billingaccounts$Buckets$Views$Get, callback: BodyResponseCallback<Schema$LogView>): void;
        get(callback: BodyResponseCallback<Schema$LogView>): void;
    }
    export interface Params$Resource$Billingaccounts$Buckets$Views$Get extends StandardParameters {
        /**
         * Required. The resource name of the policy: "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]/views/[VIEW_ID]" Example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id/views/my-view-id".
         */
        name?: string;
