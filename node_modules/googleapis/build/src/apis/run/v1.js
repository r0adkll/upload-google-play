...
(function (run_v1) {
    ...
    class Resource$Namespaces {
        constructor(context) {
            ...
            this.autodomainmappings = new Resource$Namespaces$Autodomainmappings(this.context);
    ...
    class Resource$Namespaces$Autodomainmappings {
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/apis/domains.cloudrun.com/v1/{+parent}/autodomainmappings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['parent'],
        ...
        replaceAutoDomainMapping(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    run_v1.Resource$Namespaces$Autodomainmappings = Resource$Namespaces$Autodomainmappings;
    class Resource$Namespaces$Configurations {
        ...
        replaceConfiguration(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    class Resource$Namespaces$Domainmappings {
        ...
        replaceDomainMapping(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    class Resource$Namespaces$Routes {
        ...
        replaceRoute(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    class Resource$Projects$Locations {
        constructor(context) {
            ...
            this.autodomainmappings = new Resource$Projects$Locations$Autodomainmappings(this.context);
    ...
    class Resource$Projects$Locations$Autodomainmappings {
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/autodomainmappings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['parent'],
    ...
    run_v1.Resource$Projects$Locations$Autodomainmappings = Resource$Projects$Locations$Autodomainmappings;
