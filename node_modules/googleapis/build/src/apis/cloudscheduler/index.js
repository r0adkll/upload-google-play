...
exports.VERSIONS = {
    ...
    v1beta1: v1beta1_1.cloudscheduler_v1beta1.Cloudscheduler,
};
function cloudscheduler(versionOrOptions) {
    return googleapis_common_1.getAPI('cloudscheduler', versionOrOptions, exports.VERSIONS, this);
}
