...
export declare namespace plus_v1 {
    ...
    export class Resource$Activities {
         ...
         */
        get(params: Params$Resource$Activities$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        search(params: Params$Resource$Activities$Search, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$People {
         ...
         * @return {object} Request object
         */
        list(params: Params$Resource$People$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        listByActivity(params: Params$Resource$People$Listbyactivity, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @return {object} Request object
         */
        search(params: Params$Resource$People$Search, options: StreamMethodOptions): GaxiosPromise<Readable>;
