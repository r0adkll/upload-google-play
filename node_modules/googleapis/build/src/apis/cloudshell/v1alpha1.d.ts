...
export declare namespace cloudshell_v1alpha1 {
    ...
    export class Resource$Users$Environments {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Users$Environments$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Users$Environments$Publickeys {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Users$Environments$Publickeys$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Users$Environments$Publickeys$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
