...
export declare namespace cloudfunctions_v1beta2 {
    ...
    export class Resource$Projects$Locations$Functions {
         ...
         * @return {object} Request object
         */
        update(params: Params$Resource$Projects$Locations$Functions$Update, options: StreamMethodOptions): GaxiosPromise<Readable>;
        update(params?: Params$Resource$Projects$Locations$Functions$Update, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
