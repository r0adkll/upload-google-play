...
export declare namespace games_v1 {
    ...
    export class Resource$Snapshotsextended {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resolveSnapshotHead(params: Params$Resource$Snapshotsextended$Resolvesnapshothead, options: StreamMethodOptions): GaxiosPromise<Readable>;
        resolveSnapshotHead(params?: Params$Resource$Snapshotsextended$Resolvesnapshothead, options?: MethodOptions): GaxiosPromise<Schema$ResolveSnapshotHeadResponse>;
        resolveSnapshotHead(params: Params$Resource$Snapshotsextended$Resolvesnapshothead, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        resolveSnapshotHead(params: Params$Resource$Snapshotsextended$Resolvesnapshothead, options: MethodOptions | BodyResponseCallback<Schema$ResolveSnapshotHeadResponse>, callback: BodyResponseCallback<Schema$ResolveSnapshotHeadResponse>): void;
        resolveSnapshotHead(params: Params$Resource$Snapshotsextended$Resolvesnapshothead, callback: BodyResponseCallback<Schema$ResolveSnapshotHeadResponse>): void;
        resolveSnapshotHead(callback: BodyResponseCallback<Schema$ResolveSnapshotHeadResponse>): void;
    }
    export interface Params$Resource$Snapshotsextended$Resolvesnapshothead extends StandardParameters {
        /**
         * Required. Name of the snapshot.
         */
        snapshotName?: string;
